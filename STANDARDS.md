...
## STANDARDS.md — Governance & Quality Standards > 4. Naming Conventions > JavaScript/TypeScript

- Files: `camelCase.ts` or `kebab-case.ts` (be consistent)
- Components: `PascalCase.tsx`

## STANDARDS.md — Governance & Quality Standards > 4. Naming Conventions > Java/Kotlin

- Files: `PascalCase.java` / `PascalCase.kt`
...
## STANDARDS.md — Governance & Quality Standards > 7. Plan Format Standard
...
## STANDARDS.md — Governance & Quality Standards > 8. Documentation Relevance Rule
...
## STANDARDS.md — Governance & Quality Standards > 9. Exception Rule
...
## STANDARDS.md — Governance & Quality Standards > 9. Exception Rule > Common Legitimate Exceptions
...
## STANDARDS.md — Governance & Quality Standards > 10. Error Catalog
